...
CREATE TABLE MBR(
	...
	MBR_USR_PSD    VARCHAR NULL  ,
	MBR_USR_PWD    VARCHAR NULL ,
	LOC_ID         INT  NOT NULL  ,
...
CREATE TABLE SUB(
	ANN_ID   INT  NOT NULL ,
	RES_ID   INT  NOT NULL  ,
	CONSTRAINT SUB_PK PRIMARY KEY (ANN_ID,RES_ID)

	,CONSTRAINT SUB_ANN_FK FOREIGN KEY (ANN_ID) REFERENCES ANN(ANN_ID)
